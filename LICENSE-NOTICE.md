...
- Use the hosted tool at
  https://arling.sk/firebase-auth-domain-doctor/ freely, for any
  purpose, personal or commercial, at no cost.
- Read the source of `index.html` / `doctor-firebase.js` to understand
...
- Use the "Firebase Auth Domain Doctor" name, the ARLing s. r. o.
